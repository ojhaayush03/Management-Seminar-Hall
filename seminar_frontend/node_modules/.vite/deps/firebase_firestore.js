...
function __PRIVATE_eventManagerOnWatchChange(e, t) {
  ...
  for (const e2 of t) {
    ...
    if (i) {
      for (const t3 of i.Q_) t3.W_(e2) && (r2 = true);
      i.q_ = e2;
    }
  }
...
async function __PRIVATE_syncEngineUnlisten(e, t) {
  ...
  if (i.length > 1) return n.pa.set(r2.targetId, i.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void n.ga.delete(t);
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  for (const r2 of e.pa.get(t)) e.ga.delete(r2), n && e.fa.xa(r2, n);
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r2 of n) if (r2 instanceof __PRIVATE_AddedLimboDocument) e.ba.addReference(r2.key, t), __PRIVATE_trackLimboChange(e, r2);
...
function __PRIVATE_syncEngineGetRemoteKeysForTarget(e, t) {
  ...
  if (r2 && r2.ma) return __PRIVATE_documentKeySet().add(r2.key);
  {
    let e2 = __PRIVATE_documentKeySet();
    const r3 = n.pa.get(t);
    if (!r3) return e2;
...
var __PRIVATE_AsyncQueueImpl = class {
   ...
   */
  Pu(e) {
    for (const t of this.nu) if (t.timerId === e) return true;
    return false;
  }
  /**
  ...
  Iu(e) {
    return this.hu().then(() => {
      ...
      for (const t of this.nu) if (t.skipDelay(), "all" !== e && t.timerId === e) break;
      return this.hu();
    });
  }
  /**
...
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.du)) throw t2.pu(`${e2._methodName}() can only be used with update() and set()`);
      if (!t2.path) throw t2.pu(`${e2._methodName}() is not currently supported inside arrays`);
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r2.isEqual(n)) throw t2.pu(`Document reference is for database ${r2.projectId}/${r2.database} but should be for database ${n.projectId}/${n.database}`);
      return {
